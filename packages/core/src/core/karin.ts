...
import type { Contact, FriendSender, GroupSender, Scene } from '@karinjs/adapter'

type KarinCoreType = KarinCore & {
...
export const karin: KarinCoreType = Object.assign(emitter, {
  accept,
  button,
  command,
  handler,
