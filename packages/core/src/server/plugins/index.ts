 ...
 * 获取在线插件列表
 */
export const getOnlinePluginList: RequestHandler = async (req, res) => {
  try {
 ...
 * 获取已安装插件列表详情
 */
export const getPluginListRouter: RequestHandler = async (req, res) => {
  try {
 ...
 * 获取应用插件的应用列表
 */
export const getPluginApps: RequestHandler = async (req, res) => {
  try {
    const { name } = req.body
 ...
 * 获取可更新的插件列表
 */
export const getUpdatablePlugins: RequestHandler = async (_req, res) => {
  try {
 ...
 * 批量更新插件
 */
export const batchUpdatePlugins: RequestHandler = async (req, res) => {
  try {
