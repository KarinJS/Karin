            ...
            <PopoverContent className="flex-col gap-2 p-4">
              <div className="flex gap-2">
                ...
                {showPreview && audioPreview && (
                  <Button color="primary" variant="flat" onPress={handleShowPreview}>
                    查看消息
                  </Button>
                )}
              </div>
                ...
                <div className="flex gap-1 items-center">
                  <span
                    className={clsx(
                      ...
                      isRecording ? 'animate-pulse bg-primary-400' : 'bg-success-400',
                    )}
                  ></span>
                  <span>录制时长: {formatTime(recordingTime)}</span>
                </div>
              )}
              {showPreview && audioPreview && <audio controls src={audioPreview} />}
            </PopoverContent>
          </Popover>
        </PopoverContent>
      </Popover>
