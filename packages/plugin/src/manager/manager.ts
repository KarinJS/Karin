...
import { getModuleType, isTs, NPM_EXCLUDE_LIST } from '@karinjs/envs'
import { filesByExt, formatPath, getDirs, getNodeModules, isPathEqual, isSubPath, requireFileSync } from '@karinjs/utils'

import type { PkgData } from './package'
...
import type { PluginCacheKeyFile, PluginCacheKeyPkg, PluginPackageType } from '../decorators/base'
 ...
 */
export const dir = (process.env.KARIN_PLUGINS_DIR || './plugins').replace(/\\/g, '/')
/**
 * @private
 * @description 插件加载缓存
 */
