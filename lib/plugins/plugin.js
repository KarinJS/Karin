...
export default class plugin {
  ...
  /**
   * 快速回复
   * @param {string|KarinElement|Array<KarinElement|string>} msg - 发送的消息
 ...
 *  name: string,
 *  dsc?: string,
 *  event?: 'message'|'request'|'notice'|string,
 *  priority?: number,
 *  permission?: 'master'|'owner'|'admin'|'all'|'group.owner'|'group.admin',
 *  rule: Array<{
 *    reg: string,
 *    fnc: string,
 *    event?: string,
