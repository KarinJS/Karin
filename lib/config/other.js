...
class Other {
  constructor () {
    ...
    this.ailas = () => true
    /** 白名单用户 */
    this.white_list_user = () => true
    /** 黑名单用户 */
    this.black_list_user = () => false
    /** 白名单群聊 */
    this.white_list_group = () => true
    /** 黑名单群聊 */
    this.black_list_group = () => false
    /** 白名单插件 */
    this.white_list_app = () => true
    /** 黑名单插件 */
    this.black_list_app = () => false
    /** 群消息打印 */
    this.group_msg_print = () => ''
    this.main()
  }
