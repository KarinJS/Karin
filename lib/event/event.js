 ...
 */
  ...
  reply (e) {
     ...
     */
    e.reply = async (elements = '', options = { reply: false, recallMsg: 0, at: '', button: false, retry_count: 1 }) => {
      /** 将msg格式化为数组 */
      if (!Array.isArray(elements)) elements = typeof elements == 'string' ? [segment.text(elements)] : [elements]
