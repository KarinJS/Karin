...
export class KarinRequest extends KarinEvent {
  ...
  *   },
  *   content: any,
  *   sub_type: 'friend_apply' | 'group_apply' | 'invited_group'
  * }} params
  */
  constructor ({ self_id, sub_type, time, contact, sender, user_id, raw_message = '', group_id = '' }) {
    super({ event: 'request', self_id, user_id, group_id, time, contact, sender, sub_type })
