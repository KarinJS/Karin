...
/**
 * 通知事件子类型
 * @typedef {'friend_poke' | 'friend_recall' | 'friend_file_come' | 'group_poke' | 'group_card_changed' | 'group_member_unique_title_changed' | 'group_essence_changed' | 'group_recall' | 'group_member_increase' | 'group_member_decrease' | 'group_admin_change' | 'group_member_ban' | 'group_sign_in' | 'group_whole_ban' | 'group_file_uploaded'} KarinNoticeType
 * @typedef {}
 */
...
export class KarinNotice extends KarinEvent {
  ...
  *   },
  *   content: any,
  *   sub_event: 'friend_poke' | 'friend_recall' | 'friend_file_come' | 'group_poke' | 'group_card_changed' | 'group_member_unique_title_changed' | 'group_essence_changed' | 'group_recall' | 'group_member_increase' | 'group_member_decrease' | 'group_admin_change' | 'group_member_ban' | 'group_sign_in' | 'group_whole_ban' | 'group_file_uploaded'
  * }}
  */
  constructor ({ self_id, sub_event, time, contact, sender, user_id, message_id, message_seq, raw_message = '', group_id = '' }) {
    super({ event: 'notice', self_id, user_id, group_id, time, contact, sender, sub_event })
...
export class KarinFriendFileUploadedNotice extends KarinNotice {
  sub_event = 'friend_file_uploaded'
...
export class KarinGroupUniqueTitleChangedNotice extends KarinNotice {
  sub_event = 'group_member_unique_title_changed'
...
export class KarinGroupEssenceMessageNotice extends KarinNotice {
  sub_event = 'group_essence_changed'
 ...
 * 群消息被表情回应
 */
export class KarinGroupMessagReactionNotice extends KarinNotice {
