...
/**
 * @typedef {function(Array<KarinElement>, number): Promise<{ message_id?: string }>} ReplyCallback
...
/**
 * @typedef {function(string|KarinElement|Array<KarinElement>, {at: boolean, reply: boolean, recallMsg: number, button: boolean, retry_count: number}): Promise<{ message_id?: string }>} QuickReplyCallback
