 ...
 * ```
 */
export const filesByExt = (filePath, ext, returnType = 'name') => {
 ...
 * ```
 */
export const getRelPath = (filePath) => filePath.replace(/\\+/g, '/').replace(/\.+\/+|\/+$/g, '');
/**
 ...
 * @returns 返回布尔值
 */
export const isSubPath = (root, target, isAbs = true) => {
    if (isAbs) {
