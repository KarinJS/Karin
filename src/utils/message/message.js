 ...
 * @returns 消息字符串和原始字符串
 */
export const createRawMessage = (data) => {
 ...
 * @param elements 消息
 */
export const makeMessage = (elements) => {
    if (typeof elements === 'string')
        return [segment.text(elements)];
 ...
 */
export const makeForward = (elements, fakeId, fakeName) => {
    if (!Array.isArray(elements))
        elements = [elements];
