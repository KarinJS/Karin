...
type Event = FriendNoticeEventMap[keyof FriendNoticeEventMap] | GroupNoticeEventMap[keyof GroupNoticeEventMap]

export class BaseNoticeHandler {
  event: Event
  config: ConfigType
  eventCfg!: FriendDirectFileCfg | GroupGuildFileCfg
