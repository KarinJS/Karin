...
import type { FriendDecreaseType, FriendIncreaseType, GroupPokeType, PrivateFileUploadedType, PrivatePokeType, PrivateRecallType, ReceiveLikeType, GroupRecallType, GroupFileUploadedType, GroupCardChangedType, GroupMemberUniqueTitleChangedType, GroupHlightsChangedType, GroupMemberIncreaseType, GroupMemberDecreaseType, GroupAdminChangedType, GroupSignInType, GroupMemberBanType, GroupWholeBanType, GroupMessageReactionType, GroupLuckKingType, GroupHonorChangedType, PrivateApplyType, GroupApply, GroupInvite } from './content';
/**
 * 事件父类型
 * - `message`: 消息事件
 * - `notice`: 通知事件
...
/** 创建频道私信消息事件所需参数类型 */
export type DirectMessageOptions = Omit<MessageOptions, 'subEvent' | 'contact' | 'sender'> & {
    /** 事件来源频道私信信息 */
