 ...
 * - `other`: 其他
 */
export type AdapterPlatform = 'qq' | 'wechat' | 'telegram' | 'discord' | 'koko' | 'other';
/**
 * 适配器所使用的标准接口协议
 ...
 * - `other`: 其他标准
 */
export type AdapterStandard = 'onebot11' | 'onebot12' | 'oicq' | 'icqq' | 'other';
/**
 * 适配器协议实现名称
 * - `console`: 控制台
 ...
 */
export type AdapterProtocol = 'qqbot' | 'icqq' | 'gocq-http' | 'napcat' | 'oicq' | 'llonebot' | 'conwechat' | 'lagrange' | 'console';
/**
 * 适配器通信方式
 * - `http`: HTTP 通信
 ...
 * - `other`: 其他通信方式
 */
export type AdapterCommunication = 'http' | 'webSocketServer' | 'webSocketClient' | 'grpc' | 'other';
/**
 * 适配器基本信息
 */
