...
/** 性别枚举 */
export declare const enum OB11Sex {
    Male = "male",
    Female = "female",
    Unknown = "unknown"
}
/** OneBot11消息类型枚举 */
export declare const enum OB11Event {
    Message = "message",
    Notice = "notice",
    Request = "request",
...
/** 通知事件 */
export type OB11Notice = OneBot11GroupUpload | OneBot11GroupAdmin | OneBot11GroupDecrease | OneBot11GroupIncrease | OneBot11GroupBan | OneBot11FriendAdd | OneBot11GroupRecall | OneBot11FriendRecall | OneBot11Poke | OneBot11LuckyKing | OneBot11Honor | OneBot11GroupMessageReaction | OneBot11GroupMessageReactionLagrange | OneBot11GroupEssence;
/** 请求事件基类 */
