...
import { Elements, ForwardOptions, NodeElement } from '@/types/segment';
import { AdapterType, CreateGroupFolderResponse, DownloadFileOptions, DownloadFileResponse, GetAtAllCountResponse, GetGroupFileListResponse, GetGroupFileSystemInfoResponse, GetGroupHighlightsResponse, GetGroupMuteListResponse, GroupInfo, GroupMemberInfo, MessageResponse, QQGroupHonorInfo, SendMsgResults, UserInfo } from '@/types/adapter';
import { Contact } from '@/types/event';
/**
 * 适配器基类 一个示例
 * @class AdapterBase
 */
export declare abstract class AdapterBase implements AdapterType {
