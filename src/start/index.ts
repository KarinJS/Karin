...
export const run = async () => {
  ...
  const [input, adapterService] = await Promise.all([import('../adapter/input'), import('../service/adapter'), loaderPlugin()])
  adapterService.registerBot('internal', new input.AdapterInput())
