...
import { YamlEditor } from '../file/yaml'
import { ffprobe, ffmpeg } from '../system/ffmpeg'
// TODO: 需要在core中实现
...
export { downFile } from '../file'
export { absPath } from '../path'
// export { mkdirSync as mkdir } from '../fs/fsSync'
...
export const mergeImage = async (images: string[], perRow = 3) => {
  ...
  /** 函数临时目录 */
  const root = path.join(process.env.tempPath!, 'mergeImage')
  /** 本次任务的临时目录 */
